...
(function() {
    ...
    sidebar.innerHTML = `
      ...
      <div class="sidebar-content">
        <div class="sidebar-profile-section">
          <div id="sidebarProfileIcon" class="sidebar-profile-icon" onclick="window.location.href='/profile.html'">
          ...
          <div class="sidebar-user-info">
            ...
            <div class="sidebar-view-profile" onclick="window.location.href='/profile.html'">View Profile</div>
          </div>
        </div>
        
        <div class="sidebar-menu-items">
          <a id="sidebarHomeLink" href="/categories.html" class="sidebar-menu-item">
          ...
          <a href="/community.html" class="sidebar-menu-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <a href="/wallet.html" class="sidebar-menu-item">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  function updateCategoryHomeLink() {
    ...
    const categoryMap = {
      'medical': '/medical-home.html',
      'business': '/business-home.html',
      'cinema': '/cinema-home.html',
      'education': '/education-home.html',
      'influencers': '/influencers-home.html',
      'law': '/law-home.html',
      'politics': '/politics-home.html',
      'science': '/science-home.html',
      'sports': '/sports-home.html'
    };
